...
const { getAllTable, addContact, deleteContact, updateContact } = require("api/table")

export const getAllthunk = createAsyncThunk('table/getAll', async (_, { rejectWithValue }) => {
    try {
